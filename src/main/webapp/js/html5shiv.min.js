/**
 * @preserve HTML5 Shiv 3.7.2 |  MIT/GPL2 Licensed
 */
!function (a, b) {
  function c(a, b) {
  ...
  function g(a, c, d) {
    ...
    return e = d.cache[a] ? d.cache[a].cloneNode() : p.test(a)
      ? (d.cache[a] = d.createElem(a)).cloneNode() : d.createElem(
        a), !e.canHaveChildren || o.test(a) || e.tagUrn ? e
  ...
  function h(a, c) {
    ...
    c = c || f(a);
    for (var e = c.frag.cloneNode(), g = 0, h = d(), i = h.length; i > g;
      g++) {
      e.createElement(h[g]);
    }
    return e
