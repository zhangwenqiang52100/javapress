...
<div class="row">
    <div class="eightcol last">
        <!-- Begin Form -->
        <s:form id="my-form" method="post" action="login_registerUser.action"
            ...
            <section name="第一步">
                ...
                <div><label>邮箱:</label><input id="email" name="email" data-ideal="required email"
                                              type="email"/></div>
                <div><label>出生日期:</label><input name="date" class="datepicker" data-ideal="date"
                                                type="text"
            ...
            <section name="第二步">
                <div><label>电话:</label><input type="tel" name="mobile" data-ideal="phone"/></div>
                <div><label>国籍:</label>
